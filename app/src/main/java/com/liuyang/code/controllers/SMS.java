...
public class SMS extends BaseFragment {
    ...
    protected void init() {
        ...
        find(R.id.send_mms_via_other_app).setOnClickListener(l -> {
            ...
            intent.putExtra("address", "188888888");
        ...
        find(R.id.send_sms_via_sms_manager).setOnClickListener(l -> {
            ...
            manager.sendTextMessage("18888888888", null, "send message via SmsManager", sentPI, deliveredPI);
...
//            }
//            manager.sendMultipartTextMessage("18888888888", null, messageArray, sentIntents, null);
        });
    }
